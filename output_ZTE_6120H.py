...
"""
    for i in range(len(fibra)):
            porta_fo = (portas100.pop(0) if fibra[i].get('speed') == '100000' else portas10.pop(0) if fibra[i].get('speed') == '10000' else portas1.pop(-1) if fibra[i].get('speed') == '1000' else portas10.pop(0))
